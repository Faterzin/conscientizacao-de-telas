  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        effects: { health: -2, focus: -3, social: +1, money: -1 },
        tags: ["phone", "scroll"],
      },
    ],
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        hint: "Cola, prontinho",
        effects: { focus: -8, money: -3, social: +1 },
        tags: ["ai-cheat", "phone"],
      },
    ],
  },
  ...
  // ============ DIA 2 ============
  {
    ...
    options: [
      ...
      },
      {
        ...
        effects: { health: -4, focus: -4, money: -2 },
        tags: ["phone", "scroll"],
      },
    ],
  },
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        effects: { health: -10, focus: -5, money: -3 },
        tags: ["phone", "scroll"],
      },
    ],
  },
  ...
  // ============ DIA 3 ============
  {
    ...
    options: [
      ...
      },
      {
        ...
        hint: "Arriscar",
        effects: { focus: -8, money: -4, social: -5 },
        tags: ["phone", "ai-cheat"],
      },
    ],
  },
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        effects: { health: -3, focus: -3, money: -2 },
        tags: ["scroll"],
      },
    ],
  },
  ...
  // ============ DIA 6 ============
  {
    ...
    options: [
      ...
      },
      {
        ...
        effects: { health: -5, focus: -3, money: -2 },
        tags: ["scroll"],
      },
    ],
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        effects: { social: -6, health: -3, money: -1 },
        tags: ["phone", "scroll"],
      },
    ],
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        effects: { social: -5, focus: -3, money: -1 },
        tags: ["ai-cheat", "phone"],
      },
    ],
  },
  ...
  // ============ DIA 7 ============
  {
    ...
    options: [
      ...
      },
      {
        ...
        effects: { health: -6, focus: -6, social: -4, money: -4 },
        tags: ["phone", "scroll"],
      },
    ],
  },
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        effects: { health: -8, focus: -5, money: -3 },
        tags: ["phone", "scroll"],
      },
    ],
  },
